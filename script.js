...
function showLoader() {
    ...
    setTimeout(function() {
      ...
      moneyTransaction.textContent = ` ETB ${transactionAmount}.00 debited from ${Sendername} for ${recieverName} (${transactionReason} done via Mobile) on ${currentDate} - ${currentMonth} - ${currentYear} with transactoin ID:FT24024YG901.`;
